...
export function Header() {
  ...
  return (
    <div className="grid grid-cols-24 gap-2 md:gap-4 lg:gap-6 items-center justify-between w-full h-16 bg-primary-gray-100 px-6 py-3 shadow-lg/30 border-b-2 border-b-white">
      ...
      <p className='col-span-6 hidden md:block lg:col-span-4 xl:col-span-10 md:-mx-4 lg:-mx-6 font-bold font-sans text-white text-sm lg:text-lg text-left'>lokalhost</p>
      ...
      <div className='col-span-6 md:col-span-4 gap-2 flex flex-row justify-end items-center'>
        <CTAMin className='' href={'https://www.w3schools.com'}>Source</CTAMin>
        <CTAMin className='' href={'https://www.w3schools.com'}>Docs</CTAMin>
        <CTAMin className='' href={'https://www.w3schools.com'}>Blog</CTAMin>
      </div>
